  ...
  return (
    <div className="w-[90%] m-auto py-5 mb-5">
      <div className="w-full relative">
        ...
        <div className="flex items-center">
          <div
            className={`${styles.button} items-center text-center !w-[180px] my-3 font-Poppins !bg-[crimson] cursor-pointer`}
          >
        ...
        <div className="flex items-center">
          ...
          />
          <div
            className={`${styles.button} !w-[120px] text-center my-3 ml-4 font-Poppins cursor-pointer`}
          >
            Apply
          </div>
        </div>
      ...
      <div className="w-full">
        ...
        <br />
        <h1 className="text-[25px] font-Poppins font-[600]">
          What you need to learn before this course?
        </h1>
